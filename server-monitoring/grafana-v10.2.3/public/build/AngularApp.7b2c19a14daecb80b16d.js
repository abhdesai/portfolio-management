(self.webpackChunkgrafana=self.webpackChunkgrafana||[]).push([[4704],{11461:(l,a,t)=>{var e={"./angular/panel/partials/query_editor_row.html":62386,"./angular/partials/http_settings_next.html":13978,"./angular/partials/tls_auth_settings.html":83976,"./features/admin/partials/admin_home.html":84332,"./features/admin/partials/edit_org.html":76284,"./features/admin/partials/stats.html":85809,"./features/admin/partials/styleguide.html":91868,"./features/alerting/partials/alert_tab.html":87871,"./features/annotations/partials/event_editor.html":65414,"./partials/confirm_modal.html":39097,"./partials/modal.html":70786,"./partials/reset_password.html":68697,"./partials/signup_invited.html":54854,"./plugins/panel/graph/axes_editor.html":11246,"./plugins/panel/graph/tab_display.html":46844,"./plugins/panel/graph/tab_legend.html":95987,"./plugins/panel/graph/tab_series_overrides.html":44698,"./plugins/panel/graph/tab_thresholds.html":46722,"./plugins/panel/graph/tab_time_regions.html":39801,"./plugins/panel/graph/thresholds_form.html":39638,"./plugins/panel/graph/time_regions_form.html":23120,"./plugins/panel/heatmap/partials/axes_editor.html":55760,"./plugins/panel/heatmap/partials/display_editor.html":62994,"./plugins/panel/table-old/column_options.html":91307,"./plugins/panel/table-old/editor.html":84705,"./plugins/panel/table-old/module.html":56771,"app/angular/panel/partials/query_editor_row.html":62386,"app/angular/partials/http_settings_next.html":13978,"app/angular/partials/tls_auth_settings.html":83976,"app/features/admin/partials/admin_home.html":84332,"app/features/admin/partials/edit_org.html":76284,"app/features/admin/partials/stats.html":85809,"app/features/admin/partials/styleguide.html":91868,"app/features/alerting/partials/alert_tab.html":87871,"app/features/annotations/partials/event_editor.html":65414,"app/partials/confirm_modal.html":39097,"app/partials/modal.html":70786,"app/partials/reset_password.html":68697,"app/partials/signup_invited.html":54854,"app/plugins/panel/graph/axes_editor.html":11246,"app/plugins/panel/graph/tab_display.html":46844,"app/plugins/panel/graph/tab_legend.html":95987,"app/plugins/panel/graph/tab_series_overrides.html":44698,"app/plugins/panel/graph/tab_thresholds.html":46722,"app/plugins/panel/graph/tab_time_regions.html":39801,"app/plugins/panel/graph/thresholds_form.html":39638,"app/plugins/panel/graph/time_regions_form.html":23120,"app/plugins/panel/heatmap/partials/axes_editor.html":55760,"app/plugins/panel/heatmap/partials/display_editor.html":62994,"app/plugins/panel/table-old/column_options.html":91307,"app/plugins/panel/table-old/editor.html":84705,"app/plugins/panel/table-old/module.html":56771};function n(s){var r=o(s);return t(r)}function o(s){if(!t.o(e,s)){var r=new Error("Cannot find module '"+s+"'");throw r.code="MODULE_NOT_FOUND",r}return e[s]}n.keys=function(){return Object.keys(e)},n.resolve=o,l.exports=n,n.id=11461},62386:l=>{var a=`<div ng-transclude class="gf-form-query-content"></div>

`,t=a,e="public/app/angular/panel/partials/query_editor_row.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},13978:l=>{var a=`<datasource-http-settings-next on-change="onChange" datasourceconfig="current" showaccessoptions="showAccessOption" defaulturl="suggestUrl" showforwardoauthidentityoption="showForwardOAuthIdentityOption" securesocksdsproxyenabled="secureSocksDSProxyEnabled">
`,t=a,e="public/app/angular/partials/http_settings_next.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},83976:l=>{var a=`<div class="gf-form-group">
  <div class="gf-form">
...
`,t=a,e="public/app/angular/partials/tls_auth_settings.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},84332:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
<footer>
`,t=a,e="public/app/features/admin/partials/admin_home.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},76284:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/features/admin/partials/edit_org.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},85809:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
`,t=a,e="public/app/features/admin/partials/stats.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},91868:l=>{var a=`<page-header model="ctrl.navModel"></page-header>
...
`,t=a,e="public/app/features/admin/partials/styleguide.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},87871:l=>{var a=`<div ng-if="ctrl.panel.alert">
...
`,t=a,e="public/app/features/alerting/partials/alert_tab.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},65414:l=>{var a=`
...
`,t=a,e="public/app/features/annotations/partials/event_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},39097:l=>{var a=`<div class="modal-body" ng-cloak>
...
`,t=a,e="public/app/partials/confirm_modal.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},70786:l=>{var a=`<div class="modal-header">
...
</div>`,t=a,e="public/app/partials/modal.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},68697:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/partials/reset_password.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},54854:l=>{var a=`<page-header model="navModel"></page-header>
...
<footer>
`,t=a,e="public/app/partials/signup_invited.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},11246:l=>{var a=`<div class="editor-row">
...
`,t=a,e="public/app/plugins/panel/graph/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},46844:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/tab_display.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},95987:l=>{var a=`<div class="editor-row">
...
`,t=a,e="public/app/plugins/panel/graph/tab_legend.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},44698:l=>{var a=`<div class="graph-series-override" ng-repeat="override in ctrl.panel.seriesOverrides" ng-controller="SeriesOverridesCtrl">
  <div class="gf-form">
...
`,t=a,e="public/app/plugins/panel/graph/tab_series_overrides.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},46722:l=>{var a=`<graph-threshold-form panel-ctrl="ctrl"></graph-threshold-form>
`,t=a,e="public/app/plugins/panel/graph/tab_thresholds.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},39801:l=>{var a=`<graph-time-region-form panel-ctrl="ctrl"></graph-time-region-form>
`,t=a,e="public/app/plugins/panel/graph/tab_time_regions.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},39638:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/thresholds_form.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},23120:l=>{var a=`<div class="gf-form-group">
...
`,t=a,e="public/app/plugins/panel/graph/time_regions_form.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},55760:l=>{var a=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,t=a,e="public/app/plugins/panel/heatmap/partials/axes_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},62994:l=>{var a=`<div class="editor-row">
  <div class="section gf-form-group">
...
`,t=a,e="public/app/plugins/panel/heatmap/partials/display_editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},91307:l=>{var a=`<div class="edit-tab-content" ng-repeat="style in editor.panel.styles">
  <div class="gf-form-group">
    <h5 class="section-heading">Options</h5>
    <div class="gf-form-inline">
      <div class="gf-form gf-form--grow">
...
`,t=a,e="public/app/plugins/panel/table-old/column_options.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},84705:l=>{var a=`<div class="gf-form-group">
  <div class="grafana-info-box">
...
`,t=a,e="public/app/plugins/panel/table-old/editor.html";window.angular.module("ng").run(["$templateCache",function(n){n.put(e,t)}]),l.exports=e},56771:l=>{var a=`<div class="table-panel-container">
...
//# sourceMappingURL=AngularApp.7b2c19a14daecb80b16d.js.map